...
def get_let_from_2nd_nn_ijltIL1(letter):
	...
	biases_saved = np.load('nn_two_stage/biases_ijltIL1.npy',allow_pickle=True,encoding='latin1')
	weights_saved = np.load('nn_two_stage/weights_ijltIL1.npy',allow_pickle=True,encoding='latin1')
...
def get_let_from_2nd_nn_ceg(letter):
	...
	biases_saved = np.load('nn_two_stage/biases_ceg.npy',allow_pickle=True,encoding='latin1')
	weights_saved = np.load('nn_two_stage/weights_ceg.npy',allow_pickle=True,encoding='latin1')
