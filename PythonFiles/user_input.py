...
def get_string_from_nn(all_letters):
	...
	biases_saved = np.load('./training_nn/biases_weights/biases.npy',allow_pickle=True,encoding='latin1')
	weights_saved = np.load('./training_nn/biases_weights/weights.npy',allow_pickle=True,encoding='latin1')
